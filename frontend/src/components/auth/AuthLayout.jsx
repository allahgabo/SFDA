...
export default function AuthLayout({ children, lang: propLang, onLangChange }) {
  ...
  const hero = {
    ar: {
      headline: (
        <>
          <span style={{ color: '#fff' }}>اكتشف مستقبل </span>
          <span style={{ color: '#38bdf8' }}>السفر</span>
          <br />
          <span style={{ color: '#38bdf8' }}>الذكي </span>
          <span style={{ color: '#fff' }}>في المنطقة</span>
        </>
      ),
      sub: 'نستخدم أحدث تقنيات البيانات والذكاء الاصطناعي لتوفير رؤى دقيقة وشاملة حول حركة السفر والوجهات السياحية الأكثر نمواً.',
      stats: [
